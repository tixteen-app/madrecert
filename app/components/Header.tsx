    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.a
                ...
                href={item.href}
                onClick={handleLinkClick}
                className="text-gray-700 hover:text-brand-blue transition-colors duration-200 relative group text-md font-medium cursor-pointer"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 + 0.3 }}
              >
          ...
          >
            <Button 
              className="bg-brand-gold hover:bg-brand-gold-dark text-white px-6 py-2 rounded-full transition-all duration-200 transform hover:scale-105"
              onClick={handleLinkClick}
            >
              Get Quote
            </Button>
              ...
              <nav className="px-4 py-6 space-y-4">
                {navItems.map((item, index) => (
                  <motion.a
                    ...
                    href={item.href}
                    onClick={handleLinkClick}
                    className="block text-gray-700 hover:text-brand-blue transition-colors duration-200 py-2 border-b border-gray-100 last:border-b-0 text-sm font-medium cursor-pointer"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: index * 0.1 }}
                  >
                ...
                >
                  <Button 
                    className="w-full bg-brand-gold hover:bg-brand-gold-dark text-white py-2 rounded-full"
                    onClick={handleLinkClick}
                  >
                    Get Quote
                  </Button>
